...
HD_PWD='C:/Users/Marco/Desktop/GitHub/Architettura/Esercizio3/on_board/on_board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_button_prova.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_button_prova.tcl -notrace
