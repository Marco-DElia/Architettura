...
HD_PWD='C:/Users/Marco/Desktop/GitHub/Architettura/Esercizio3/on_board/on_board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_button_prova.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_button_prova.tcl
